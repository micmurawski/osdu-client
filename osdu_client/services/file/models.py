...
#   timestamp: 2024-07-09T19:33:14+00:00
...
class FileSourceInfo(BaseModel):
    ...
    EncodingFormatTypeID: Optional[
        constr(
            regex=r'^srn:<namespace>:reference-data\\/EncodingFormatType:[^:]+:[0-9]*$'
        )
...
class FileSourceInfoObject(BaseModel):
    ...
    Checksum: Optional[constr(regex=r'^([0-9a-fA-F]{2})+$')] = Field(
        None,
...
class CopyDmsResponse(BaseModel):
    __root__: List[CopyDmsResponseItem]
...
class FileCollections(BaseModel):
    ...
    TotalSize: Optional[constr(regex=r'^[0-9]+$')] = Field(
        None,
    ...
    SchemaFormatTypeID: Optional[
        constr(
            regex=r'^srn:<namespace>:reference-data\\/SchemaFormatType:[^:]+:[0-9]*$'
        )
    ...
    Checksum: Optional[constr(regex=r'^[0-9a-fA-F]32}$')] = Field(
