...
@pytest.fixture(scope="session")
def entitlements_client(auth_backend: AuthBackendInterface) -> OSDUAPIClient:
    return OSDUAPI.client("entitlements", auth_backend=auth_backend)
