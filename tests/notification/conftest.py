...
@pytest.fixture(scope="session")
def notification_client(auth_backend: AuthBackendInterface) -> OSDUAPIClient:
    return OSDUAPI.client("notification", auth_backend=auth_backend)
