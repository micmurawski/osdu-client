...
@pytest.fixture(scope="session")
def welldelivery_client(auth_backend: AuthBackendInterface) -> OSDUAPIClient:
    return OSDUAPI.client("welldelivery", auth_backend=auth_backend)
